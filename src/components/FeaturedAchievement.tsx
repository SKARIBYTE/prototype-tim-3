    ...
    <section className="relative w-full bg-white py-24 sm:py-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 relative z-10 group">
            <div className="relative aspect-4/5 rounded-2xl overflow-hidden shadow-2xl">
              ...
              />
                        ...
                        <div className="absolute bottom-6 right-4 sm:-bottom-6 sm:-right-6 lg:-right-12 bg-blue-600 text-white p-5 sm:p-6 rounded-2xl shadow-xl z-20 max-w-[200px] sm:max-w-[240px]">
              <div className="font-bold text-2xl sm:text-3xl tracking-tight mb-1">2025</div>
          ...
          >
            <Quote className="absolute top-4 sm:-top-8 right-6 sm:left-auto sm:-left-6 w-16 h-16 sm:w-24 sm:h-24 text-slate-100 -z-10 rotate-180" />
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 tracking-tighter leading-[1.1] mb-8">
              "Bukan sekadar menang, tapi <span className="text-blue-600">membuktikan</span> bahwa SMK bisa mendunia."
            </h2>

            <div className="space-y-6 text-lg text-slate-600 leading-relaxed mb-10">
              <p>
                Risca Revan Suasmara dan Edsel Parama Mustapa mengukir sejarah dengan membawa pulang 
                <strong> Medali Emas & Perunggu</strong> di ajang ASEAN Worldskills 2025 untuk bidang 
                <em> IT Software Solution for Business</em>.
              </p>
              <p className="text-base text-slate-500">
                Pencapaian ini adalah hasil dari ribuan jam latihan di laboratorium sekolah, dedikasi tanpa henti, dan dukungan penuh dari para guru pembimbing yang percaya bahwa potensi siswa-siswi SMK PGRI 3 Malang tidak memiliki batas.
              </p>
            </div>
