      ...
      <div className="sticky top-0 h-dvh overflow-hidden cursor-default">
        <motion.div className="absolute inset-0 z-0" style={{ scale, filter: blurFilter }}>
          <video
            ...
            poster="https://picsum.photos/seed/hero-skariga/1920/1080"
          >
        ...
        >
          ...
          <motion.h1
            ...
            className="font-neuropol text-[clamp(4rem,15vw,11rem)] font-bold leading-none tracking-widest drop-shadow-2xl mb-8"
          >
            SKARIGA
          </motion.h1>
