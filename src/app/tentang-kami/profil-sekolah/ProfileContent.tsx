  ...
  return (
    <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16 overflow-hidden bg-white">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-5 relative group overflow-hidden rounded-2xl">
            <Image
              ...
              width={600}
              height={400}
              className="w-full h-85 object-cover rounded-2xl group-hover:scale-105 transition-transform duration-700 ease-out"
            />
          ...
          <div className="lg:col-span-7 space-y-4">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-100 text-slate-700 text-xs font-medium">
              <span className="w-2 h-2 rounded-full bg-primary" /> Profile
              Overview
            </div>
            ...
            <p className="text-slate-600 leading-relaxed text-base">
              SMK PGRI 3 Malang merupakan sekolah kejuruan terkemuka yang
              berkomitmen menghadirkan pendidikan vokasi berkualitas tinggi.
              Kami membentuk lulusan yang tidak hanya unggul secara akademis dan
              teknis, tetapi juga memiliki integritas karakter serta kesiapan
              adaptasi di dunia kerja maupun jenjang perguruan tinggi.
            </p>
      ...
      >
        ...
        >
          ...
          <p className="text-slate-600 leading-relaxed">
            Menjadi SMK unggul yang menghasilkan lulusan profesional,
            berkarakter mulia, inovatif, serta berdaya saing tinggi di era
            industri global.
          </p>
        </motion.div>
      ...
      >
        ...
        >
          ...
          <p className="text-xs text-slate-500">
            Perjalanan pengembangan SMK PGRI 3 Malang
          </p>
        </motion.div>
      ...
      <motion.div
        ...
        whileInView="show"
        viewport={{ once: true, margin: "-50px" }}
        className="bg-secondary text-white rounded-3xl p-8 sm:p-10 shadow-md flex flex-col md:flex-row items-center justify-between gap-6"
      >
        <motion.div
          variants={fadeUp}
          className="space-y-2 text-center md:text-left"
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-primary-light text-xs font-semibold border border-white/20">
            Standar Mutu Pendidikan
          </div>
          <h3 className="text-xl sm:text-2xl font-bold">
            Terakreditasi & Tersertifikasi Resmi
          </h3>
          <p className="text-xs sm:text-sm text-white/90 max-w-lg">
            Lulusan dibekali ijazah dan sertifikat kompetensi yang diakui oleh
            dunia usaha dan industri nasional.
          </p>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-3 gap-3 w-full md:w-auto">
          {certifications.map((c, idx) => (
            <motion.div
              key={idx}
              variants={fadeUp}
              className="bg-white/10 border border-white/20 p-4 rounded-2xl text-center space-y-1"
            >
              <h4 className="font-bold text-xs text-white">{c.name}</h4>
              <p className="text-[10px] text-white/80">{c.detail}</p>
            </motion.div>
          ))}
        </div>
      </motion.div>
