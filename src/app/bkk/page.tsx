...
import { bkkJobs } from "@/data/mockData";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-white rounded-2xl p-8 border border-slate-200">
            ...
            <p className="text-slate-600 mb-6 leading-relaxed">
              Praktik Kerja Lapangan (PKL) adalah program wajib bagi seluruh siswa SMK PGRI 3 Malang untuk mendapatkan pengalaman kerja nyata di industri. BKK memfasilitasi penempatan siswa di ratusan mitra industri terpercaya.
            </p>
